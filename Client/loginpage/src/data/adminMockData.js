// Load logged-in admin user from localStorage for live session data
const _adminUser = (() => {
  try {
    const s = localStorage.getItem('medicare_admin_user');
    return s ? JSON.parse(s) : null;
  } catch { return null; }
})();

export const initialAdminProfile = {
  name: _adminUser?.name || "Aryan Kulkarni",
  email: _adminUser?.email || "aryankulkarni2048@gmail.com",
