    ...
    <form onSubmit={handleSubmit} className="space-y-4 mt-4">
      <div>
        ...
        <div className="relative">
          <UserCheck className="w-5 h-5 absolute left-3 top-1/2 -translate-y-1/2 text-[#64748B]" />
          <input
            type="text"
            required
            value={doctorId}
      ...
      <div className="text-center text-sm text-[#64748B] pt-2">
        New to MediCare Hospital?{' '}
        <Link to="/register/doctor" className="text-[#2490C9] font-semibold hover:text-[#126B9E] hover:underline">
