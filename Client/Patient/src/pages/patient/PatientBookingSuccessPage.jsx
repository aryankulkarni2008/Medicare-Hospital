...
import { CheckCircle, Home, Calendar as CalendarIcon, Clock, User } from 'lucide-react';
      ...
      <div className="w-full max-w-lg bg-white rounded-2xl border border-[#D9E6EC] p-10 text-center shadow-[0_8px_30px_rgb(0,0,0,0.04)] transform transition-all duration-500 animate-in fade-in zoom-in-95">
        ...
        <div className="bg-[#F4F9FC] rounded-xl p-6 text-left border border-[#D9E6EC] space-y-4 mb-8">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-xs font-semibold text-[#64748B] uppercase tracking-wider mb-1">Doctor & Specialty</p>
              <p className="font-bold text-[#102A43] text-sm">{appointment.doctorName} ({appointment.specialty})</p>
            </div>
          </div>
        ...
        <button
          ...
          className="w-full py-4 text-sm font-bold text-white bg-[#102A43] rounded-xl hover:bg-[#2490C9] transition-all shadow-md flex items-center justify-center space-x-2 cursor-pointer"
        >
